...
from autocoder_nano.acinit import initialize_system, configure_project_model
from autocoder_nano.utils.completer_utils import CommandCompleter
from autocoder_nano.version import __version__
from autocoder_nano.utils.git_utils import commit_changes, get_uncommitted_changes, generate_commit_message
...
def main():
    ...
    if not _raw_args.quick:
        initialize_system(project_root=project_root)
